    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-6">
        ...
        <div>
          ...
          {images.map((url, i) => (
            <div key={i} className="flex gap-2 mb-2">
              <input type="text" value={url} onChange={(e) => updateImage(i, e.target.value)} placeholder="https://..." className="flex-1 rounded-xl border border-neutral-200 px-4 py-2 text-neutral-900" />
        ...
        <div>
          ...
          {variants.map((v, i) => (
            <div key={i} className="flex flex-wrap gap-2 mb-2 items-center">
              ...
              <input type="text" value={v.image || ''} onChange={(e) => updateVariant(i, 'image', e.target.value)} placeholder="Image URL" className="flex-1 min-w-[120px] rounded-lg border border-neutral-200 px-2 py-1.5 text-sm" />
