        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 480px;">
          ...
          <tr>
            <td style="background-color: #1c1917; padding: 28px 32px; border-radius: 16px 16px 0 0;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td>
                    <span style="font-size: 22px; font-weight: 600; color: #c9a227; letter-spacing: 0.02em;">Nature Secret</span>
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            <td style="background-color: #ffffff; padding: 32px; border-left: 1px solid #e7e5e4; border-right: 1px solid #e7e5e4;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="left">
                <tr>
                  <td style="border-radius: 12px; background-color: #1c1917;">
                    <a href="${link}" target="_blank" style="display: inline-block; padding: 14px 28px; font-size: 15px; font-weight: 600; color: #c9a227; text-decoration: none; letter-spacing: 0.02em;">Reset password</a>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin: 16px 0 0; font-size: 12px; color: #a8a29e; line-height: 1.5; word-break: break-all;">Or copy this link: <a href="${link}" style="color: #c9a227;">${link}</a></p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
