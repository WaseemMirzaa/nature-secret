...
export function networkRetryInlineScript() {
  ...
  function isNet(m){if(!m)return false;var s=String(m).toLowerCase();return s.indexOf('failed to fetch')!==-1||s.indexOf('fetch failed')!==-1||s.indexOf('networkerror')!==-1||s.indexOf('network request failed')!==-1||s.indexOf('load failed')!==-1||s.indexOf('err_internet')!==-1||s.indexOf('net::err')!==-1||s.indexOf('timeout')!==-1||s.indexOf('timed out')!==-1;}
