...
import { INITIAL_ORDERS, PRODUCTS as INITIAL_PRODUCTS, BLOG_POSTS as INITIAL_BLOG_POSTS, INITIAL_ANALYTICS_EVENTS } from './dummy-data';
      ...
      track: (type, data = {}) =>
        set((state) => {
          ...
          return {
            events: [
              ...state.events,
              { type, ...data, ...customerInfo, timestamp: new Date().toISOString(), sessionId },
            ].slice(-5000),
          };
        }),
      clear: () => set({ events: [] }),
