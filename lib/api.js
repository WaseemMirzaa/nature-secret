...
/** Client-side fetch timeout (ms). Browsers have no default; slow 2G/3G needs headroom. Override with NEXT_PUBLIC_API_TIMEOUT_MS. */
const DEFAULT_API_REQUEST_TIMEOUT_MS = 120000;

function getApiRequestTimeoutMs() {
  if (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_API_TIMEOUT_MS) {
