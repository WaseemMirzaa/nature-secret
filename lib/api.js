 ...
 * Set NEXT_PUBLIC_API_URL at build time to your backend origin (e.g. https://shifaefitrat.com).
 * If frontend is on naturesecret.pk and API is on another domain, 404 on login means this env is wrong or unset.
 */
function getBase() {
