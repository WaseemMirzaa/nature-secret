...
export async function apiRequest(path, options = {}) {
  ...
  const useCustomerAuth = !isAdminPath && (path.startsWith('/orders') || path.startsWith('/customers'));
...
export async function getAdminPushVapidPublic() {
  return api.get('/admin/push/vapid-public');
}

export async function subscribePush(subscription) {
  return api.post('/admin/push/subscribe', { subscription });
}
