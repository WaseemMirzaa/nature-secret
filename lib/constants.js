...
export const SHIPPING_POLICY = 'Free shipping on orders above Rs 999. Standard delivery in 3–7 days. Express available at checkout.';
...
/** PDP hero + LCP preload. Mobile: cap at 640px slot so srcset won’t pick ~1920px; desktop: grid column widths. */
export const PRODUCT_HERO_IMAGE_SIZES =
  '(max-width: 1023px) min(100vw, 640px), (max-width: 1279px) min(576px, 50vw), 448px';
