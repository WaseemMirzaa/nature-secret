/**
 * Session-only NS150 promo: Rs 150 off, must apply code within countdown (default 120s from first visit this tab).
...
export const NS_PROMO_COUNTDOWN_MS = 120 * 1000;

const KEY_DEADLINE = 'nature_secret_ns_promo_deadline';
