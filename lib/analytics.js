...
/**
 * Meta Pixel + CAPI: each browser `fbq` event is mirrored server-side with the same
 * custom_data fields (and matching event_id when Pixel passes eventID for deduplication).
 */
