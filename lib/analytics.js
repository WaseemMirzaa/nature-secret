...
/**
 * Meta Pixel + CAPI (gate: first landing `/` + Meta traffic — see meta-pixel-gate.js):
 * Pixel+CAPI (deduped): Purchase, AddToCart, InitiateCheckout.
 * CAPI only: NS_EV_LANDING_PAGE_VIEW, NS_EV_CONTENT_VIEW, NS_EV_ATC, NS_EV_INTCHECKOUT, NS_EV_PRCHS_SUCCESS.
 * Pixel only: ViewContent, AddToWishlist.
 */
