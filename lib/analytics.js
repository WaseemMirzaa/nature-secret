 ...
 * Standard events (Purchase, AddToCart, InitiateCheckout, …) mirror to CAPI with matching event_id.
 * Custom NS_EV_PRCHS_SUCCESS, NS_EV_ATC, NS_EV_INTCHECKOUT are CAPI-only (no Pixel trackCustom).
 */
