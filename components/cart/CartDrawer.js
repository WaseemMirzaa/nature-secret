      ...
      <div className="fixed top-0 right-0 z-50 h-full w-full max-w-md bg-white shadow-premium flex flex-col animate-slide-up">
        ...
        {items.length > 0 && (
          <div className="border-t border-neutral-200 p-4 space-y-3">
            ...
            <Link href="/checkout" onClick={close} className="block w-full rounded-xl bg-neutral-900 text-white text-center py-3 font-medium animate-cta-pulse hover:animate-none transition">Checkout</Link>
          </div>
        )}
      </div>
    </>
