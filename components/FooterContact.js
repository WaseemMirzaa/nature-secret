...
export function FooterContact() {
  ...
  const waUrl = whatsappUrl(c.whatsappNumber);
  ...
  return (
    <p className="mt-3 text-xs text-neutral-500 flex flex-wrap items-center gap-x-2 gap-y-1">
      ...
      <a href={waUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-[#25D366] hover:underline" aria-label="Chat on WhatsApp">
